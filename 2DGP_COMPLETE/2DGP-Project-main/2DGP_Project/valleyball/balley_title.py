...
from tennis.background import p1_layer, p2_layer, ui, background, chair, safe_bar
from tennis.flag import Flag
from tennis.referee import referee
from valleyball import balley_2player_mode, balley_1player_mode
from valleyball.Player1 import player1
from valleyball.Player2 import player2
from valleyball.ball import Ball
    ...
    for event in events:
        if event.key == SDLK_ESCAPE:
            ...
            if mx > 340 and mx < 880 and my > 300 and my < 430:
                game_framework.change_mode(balley_1player_mode)
